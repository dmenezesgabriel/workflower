...
class Config:
    ...
    LOGGING_PATH = os.getenv("LOGGING_PATH", "/data/logs")
    LOGGING_FILE = os.getenv("LOGGING_FILE", "log.log")
    ENVIRONMENTS_DIR = os.getenv("ENVIRONMENTS_DIR", "/data/environments")
    KERNELS_SPECS_DIR = os.getenv("KERNELS_SPECS_DIR", "/data/kernel_specs")
